    ...
    <div class="col-lg-6 offset-md-4">
        <form>
            <div class="form-group row">
                <label for="reg_nama" class="col-sm-2 col-form-label">Nama</label>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <label for="reg_confirm" class="col-sm-2 col-form-label">Confirm Password</label>
                <div class="col-sm-8">
                <input type="password" class="form-control" id="reg_confirm" placeholder="password">
                </div>
            </div>
            <div class="form-group row">
                <label for="reg_profesi" class="col-sm-2 col-form-label">Daftar Sebagai</label>
                <div class="col-sm-8">
